...
import { bookmarkClass, IBookmarksManager, BookmarkType } from 'vs/workbench/contrib/monorepoTree/common/bookmarks';
import { Directory, IDirectoryTemplateData, DirectoryElementIconRenderer, DirectoryRenderer } from 'vs/workbench/contrib/monorepoTree/browser/directoryViewer';
