...
import { BookmarkHeader } from 'vs/workbench/contrib/monorepoTree/browser/bookmarksView';
...
import { Directory } from 'vs/workbench/contrib/monorepoTree/browser/directoryViewer';
