...
import { getDirectoriesAsSortedTreeElements, findIndexInSortedArray, Directory } from 'vs/workbench/contrib/monorepoTree/browser/directoryViewer';
import { URI } from 'vs/base/common/uri';
import { SortType } from 'vs/workbench/contrib/monorepoTree/common/bookmarks';
