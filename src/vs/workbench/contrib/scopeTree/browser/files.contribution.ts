...
import { ExplorerViewletViewsContribution } from 'vs/workbench/contrib/scopeTree/browser/explorerViewlet';
...
import { ExplorerService } from 'vs/workbench/contrib/scopeTree/common/explorerService';
