...
import { compareFileExtensionsDefault, compareFileNamesDefault } from 'vs/base/common/comparers';
...
class FocusIconRenderer implements IDisposable {
	...
	constructor(private stat: ExplorerItem) {
		...
		this._iconContainer.classList.add('scope-tree-focus-icon-file-tree-aligned');
...
export class FileDragAndDrop implements ITreeDragAndDrop<ExplorerItem> {
	...
	private handleDragOver(data: IDragAndDropData, target: ExplorerItem | undefined, targetIndex: number | undefined, originalEvent: DragEvent): boolean | ITreeDragOverReaction {
		...
		const fromDesktop = data instanceof NativeDragAndDropData;
